...
def get_my_categories(
    ...
    include_subcategories: bool = Query(default=True, description="Incluir subcategorias")
):
    cats = list_categories(db, current_user.id, include_subcategories=include_subcategories)
